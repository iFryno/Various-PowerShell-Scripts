...
- **Digital Markets Act** - Enables EU DMA compliance, allowing native removal of enforced apps like Edge and Store, reducing the amount of diagnostic data sent, and unlocking additional system settings. For more information, see [here](https://www.youtube.com/watch?v=MfBNxGw_5J8&t=7s)
