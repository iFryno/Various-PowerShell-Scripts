...
- **[Digital Markets Act](Digital%20Markets%20Act.ps1)** - Allows native removal of enforced apps such as Edge and Store, reduces telemetry, and unlocks additional system settings. Learn more [here](https://youtu.be/MfBNxGw_5J8?is=VMEVvqxa6HWFmF2N).
...
- **[Manage Windows Updates](Manage%20Windows%20Updates.ps1)** - Pauses Windows updates for 1 year, disables them entirely or disables driver updates.
