    ...
    Write-Host "Manage Windows Updates"
    Write-Host ""
    Write-Host "1.Pause"
    Write-Host "2.Unpause"
    Write-Host ""
...
# disable updates
Reg.exe add 'HKLM\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate' /v 'WUServer' /t REG_SZ /d 'https://FuckMicroslop.com/' /f *> $null
Reg.exe add 'HKLM\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate' /v 'WUStatusServer' /t REG_SZ /d 'https://FuckMicroslop.com/' /f *> $null
Reg.exe add 'HKLM\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate' /v 'UpdateServiceUrlAlternate' /t REG_SZ /d 'https://FuckMicroslop.com/' /f *> $null
